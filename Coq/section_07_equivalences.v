...
Proof.
  ...
  (* If you try
     ...
     simple refine (section_comp' _ _ _).

     in the following step, the first subgoal will be to construct a Type. I would expect the first subgoal to be the type of

     (hom_slice_retr_map_hom_slice h (retr_is_equiv is_equiv_g))

     So the types in the goals generated by simple refine f (_ _ _) might not match the types of the arguments of f!
   *)
