...
\begin{exercises}
\item \index{identity type!as pullback}
\begin{subexenum}
...
\item Show that if $g$ is $k$-truncated, then so is $p$.\index{truncated!map!pullback stability}
\end{subexenum}
...
\end{enumerate}
\item Sometimes pullbacks are also called \emph{fiber products}\index{fiber products}. In this exercise we see why.
