...
By \cref{ex:circle_up_pushout} and the second characterization of pushouts in \cref{thm:pushout_up} it follows that the circle is a pushout\index{circle!S1 equiv susp 2@{$\eqv{\sphere{1}}{\susp\bool}$}}
\begin{equation*}
\begin{tikzcd}
