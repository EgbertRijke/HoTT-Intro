...
\begin{proof}
  ...
  \end{equation*}
  is an equivalence. Note that usually we just write $P$ for the underlying type $\proj 1(P)$ of a proposition $P:\prop$, but here it is useful to keep the notation explicit. Now we observe that we have a commuting square
  \begin{equation*}
