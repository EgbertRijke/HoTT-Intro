...
\begin{eg}
  The type of natural numbers\index{N@{$\N$}!is a poset with leq@{is a poset with $\leq$}}\index{N@{$\N$}!is a poset with divisibility}\index{poset!N with leq@{$\N$ with $\leq$}}\index{poset!N with divisibility@{$\N$ with divilibility}} comes equipped with at least two important poset structures. The first is given by the usual ordering relation $\leq$, and the second is given by the relation $d\mid n$ that $d$ divides $n$.
\end{eg}
