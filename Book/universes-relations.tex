...
\exercise
  \begin{subexenum}
  \item \label{ex:strong-induction}Show that $\N$ satisfies \define{strong induction}, i.e., construct for any type family $P$ over $\N$ a function $\mathbf{ind}_\N$ of type
    \begin{equation*}
