...
Let $f,g:A\to B$ be functions, and consider $H:f\htpy g$ and $p:x=y$ in $A$. We define the identification\index{htpy-nat@{$\htpynat$}}\index{homotopy!htpy-nat@{$\htpynat$}}
\begin{equation*}
