...
\item \emph{$A$ is a (well-formed) \define{type} in context $\Gamma$.}
  ...
  The symbolic expression for this judgment is\index{Gamma turnstyle A type@{$\Gamma\vdash A~\mathrm{type}$}}\index{judgment!Gamma turnstyle A type@{$\Gamma\vdash A~\mathrm{type}$}}
  \begin{equation*}
    \Gamma\vdash A~\mathrm{type}
  \end{equation*}
\item \emph{$A$ and $B$ are \define{judgmentally equal types} in context $\Gamma$.}
  \index{judgmental equality!of types} The symbolic expression for this judgment is\index{Gamma turnstyle A is B type@{$\Gamma\vdash A\jdeq B~\mathrm{type}$}}\index{judgment!Gamma turnstyle A is B type@{$\Gamma\vdash A\jdeq B~\mathrm{type}$}}
  \begin{equation*}
