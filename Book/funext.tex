...
\begin{proof}
To show that (i) implies (ii), we first recall from \crefl{lem:coherently-invertible} that any equivalence is also coherently invertible. Therefore $f$ comes equipped with
\begin{align*}
g & : B \to A\\
