\section{Propositional truncations and the image of a map}\label{chap:image}
...
%  \item For any two propositions $P$ and $Q$, define
%  \begin{equation*}
%  P\boxplus Q \defeq ((P\to Q)\to Q)\times ((Q\to P)\to P).
%  \end{equation*}
%  Show that $P\lor Q\to P\boxplus Q$ and $P\boxplus Q\to\neg(\neg P\land \neg Q)$. In other words, the type $P\boxplus Q$ sits between the disjunction and the double negation translation of the disjunction.
  \end{subexenum}
