...
\end{tikzcd}
\end{equation*}
\item Consider a pullback square\index{pullback!Sigma-type of pullbacks@{$\Sigma$-type of pullbacks}}
  \begin{equation*}
    \begin{tikzcd}
      C \arrow[r,"q"] \arrow[d,swap,"p"] & B \arrow[d,"g"] \\
      A \arrow[r,swap,"f"] & X
  ...
  \begin{equation}\label{eq:family-squares-pullback}
    ...
    \end{tikzcd}
  \end{equation}
  commutes. Construct a homotopy witnessing that the square
  \begin{equation}\label{eq:total-square-pullback}
    ...
    \end{tikzcd}
  \end{equation}
  commutes, and show that the following are equivalent:
  \begin{enumerate}
  \item For each $c:C$ the square in \cref{eq:family-squares-pullback} is a pullback square.
  \item The square in \cref{eq:total-square-pullback} is a pullback square.
  \end{enumerate}
